...
function MovieRates({ movie }) {
  ...
  return (
    <div className="my-12">
      ...
      <div className="mt-10 xl:grid flex-colo grid-cols-5 gap-12 bg-dry xs:p-10 py-10 px-2 rounded">
        {/* write revie */}
        <div className="xl:col-span-2 w-full flex flex-col gap-8">
          ...
          <p className="text-sm leading-7 font-medium text-border">
            ...
            ipsum dolor sit amet consectetur, adipisicing elit. Porro iure
            cupiditate ipsa sed ea ab.
          </p>
          ...
          {/* message */}
          <Message label="Message" placeholder="Make it shor and sweet..." />
          {/* submit */}
